    ...
    <>
      ...
      <div className="authBg w-[100vw] h-[90vh] flex flex-col justify-evenly items-center  font-Inter mb-10">    
          ...
          <h1 className="text-3xl font-Lobster text-center p-4">
            Welcome To FoodieLand! Signup Now to explore tasty recipe's and foodie's around you!
          </h1>
            <div className="w-full max-w-md mx-auto md:max-w-sm md:px-0 md:w-96 sm:px-4">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mt-4 space-y-6">
                  ...
                  <div className="col-span-full">
                    <p className="text-sm p-2">Already have account<Link to="/auth/login"><span className="text-blue-400 pl-1 border-blue-400 cursor-pointer hover:border-b-2"> Login </span></Link></p>
                    <button
                      type="submit"
